...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = rootView.findViewById(R.id.rvRecycle);
    ...
    private void setUpAminoAcidModels(){
        bookModel.add(new Book("A","AA", "AAA", "AAAA", R.drawable.img));
        bookModel.add(new Book("B","BB", "BBB", "BBBB", R.drawable.img));
        bookModel.add(new Book("A","AA", "AAA", "AAAA", R.drawable.img));
        bookModel.add(new Book("B","BB", "BBB", "BBBB", R.drawable.img));
        bookModel.add(new Book("A","AA", "AAA", "AAAA", R.drawable.img));
        bookModel.add(new Book("B","BB", "BBB", "BBBB", R.drawable.img));
